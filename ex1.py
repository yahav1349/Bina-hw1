...
class TaxiProblem(search.Problem):
    ...
    def h_2(self, node):
        ...
        total_d = 0
        total_t = 0
        unpicked_or_dropped_off = state['unpicked'] + state['dropped_off']
        in_taxi = state['passengers'].keys() - unpicked_or_dropped_off
    ...
    def new_admissible_distance_heuristic(self, node):
        """
        This is a new admissible heuristic
        """
